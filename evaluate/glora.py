...
def main(
    ...
    *,
    ...
    glora_path: Path = Path("out/glora/alpaca/iter-083199-ckpt.pth"),
    ...
    with lazy_load(checkpoint_path) as pretrained_checkpoint, lazy_load(glora_path) as glora_checkpoint:
        ...
        with EmptyInitOnDevice(
            ...
            model.load_state_dict(glora_checkpoint, strict=False)
